  ...
  return (
    <div>
      ...
      <Box sx={{ marginTop: "20px" }}>
        ...
        <Box component="form" onSubmit={handleDeactivateClick} noValidate sx={{ mt: 1 }}>
          <TextField
            margin="normal"
            required
            fullWidth
            ...
            autoComplete="name"
            autoFocus
            value={deactivateDoctorId}
            onChange={(event) => setDeactivateDoctorId(event.target.value)}
          />
          <Button type="submit" fullWidth variant="contained" sx={{ mt: 3, mb: 2 }}>
            Deactivate Doctor
          </Button>
...
export default DectivateDoctor;